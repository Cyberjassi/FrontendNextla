        ...
        <section className="col-md-9">
          <div className="card shadow">
            <h5 className="card-header text-center bg-primary text-white">
              ...
              <Link
                href={`/teacher/add-study-material/${currentCourse}`}
                className="btn btn-sm btn-success float ccard"
              >
                Add Study Material
              </Link>
            </h5>
                ...
                <tbody>
                  {studyData &&
                    studyData.map((row: any, index: any) => (
                      <tr key={index}>
                        <td>
                          <Link className="link-none" href="#">
                            {row.title}
                          </Link>
                        </td>
                        <td>
                          <Link className="link-none" href={row.upload}>
                            File
                          </Link>
                        </td>
                        <td>
