                    ...
                    courseData.map((course: any, index: any) => (
                      <tr key={index}>
                        ...
                        <td>
                          <Link
                            className="link-none"
                            href={`enrolled-students/${course.id}`}
                          >
                        ...
                        <td>
                          <Link
                            className="btn btn-info btn-sm ccard"
                            href={`/teacher/edit-course/${course.id}`}
                          >
                            Edit
                          </Link>
                          <Link
                            className="btn btn-warning btn-sm ms-2 ccard"
                            href={`/teacher/study-material/${course.id}`}
                          >
                            Study Material
                          </Link>
                          <Link
                            className="btn btn-success btn-sm  ms-2 ccard"
                            href={`/teacher/add-chapter/${course.id}`}
                          >
                            Add Chapters
                          </Link>
                          <button
                            onClick={() => deleteAndFetchData(course.id)}
