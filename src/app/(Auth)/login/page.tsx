  ...
  <div className="row">
    <div className="col-6 offset-3">
      <div className="card shadow">
        <h5 className="card-header text-center bg-primary text-white">Login</h5>
        <div className="card-body">
          <label htmlFor="loginAs" className="form-label">Login As-</label>
          <br />
          <div className="form-check form-check-inline mb-3">
            <input onChange={(e) => setCheck(e.target.value)} className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="Teacher" />
            <label className="form-check-label" htmlFor="inlineRadio1">Teacher</label>
          </div>
          <div className="form-check form-check-inline">
            <input onChange={(e) => setCheck(e.target.value)} className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="Student" defaultChecked />
          ...
          {check === "Teacher" && (
            <form onSubmit={submitForm} className="mt-1">
              <div className="mb-3">
                ...
                <input name="email" type="email" onChange={handleChange} value={teacherData.email} placeholder="Enter Your Email" className="form-control" />
              </div>
              <div className="mb-3">
                <label className="form-label">Password</label>
                <input placeholder="Enter Your Password" onChange={handleChange} value={teacherData.password} name="password" type="password" className="form-control" />
              </div>
          ...
          {check === "Student" && (
            <form onSubmit={submitFormStudent} className="mt-1">
              <div className="mb-3">
                <label className="form-label">Email</label>
                <input name="email" type="email" onChange={handleChangeStudent} value={StudentData.email} placeholder="Enter Your Email" className="form-control" />
              </div>
              <div className="mb-3">
                <label className="form-label">Password</label>
                <input placeholder="Enter Your Password" onChange={handleChangeStudent} value={StudentData.password} name="password" type="password" className="form-control" />
              </div>
              <button type="submit" className="btn btn-primary w-100">Login</button>
            </form>
          )}
          ...
          {forgotStatus && (
            <p className="mt-3">
              <Link href={check === "Teacher" ? "/teacher-forgot-password" : "/student-forgot-password"} className="text-danger link-none text-sm">
                Forget Password?
              </Link>
            </p>
          )}
