      ...
      <div className="container mt-10">
        <div className="row">
          ...
          <div className="col-8">
            ...
            <p className="fw-bold">
              ...
              {skillList &&
                skillList.map((skill: any, index: any) => (
                  <Link
                    key={index}
                    href={`/teacher-skills-courses/${skill.trim()}/${
                      teacherData.id
                    }`}
                    className="badge badge-pill text-dark bg-warning ml-1 link-none ccard"
                  >
                    {skill}
                  </Link>
                ))}
            ...
            <p className="fw-bold">
              Recent Course:{" "}
              <Link className="custom-link-style" href="/course-detail/1">
                Php
              </Link>
            </p>
            ...
            {courseData.map((course: any) => (
              ...
              >
                <ListItem
                  button
                  component="a"
                  className="list-group-item text-start list-group-item-action"
